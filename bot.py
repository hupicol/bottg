...
def send_coffee_facts(message):
    ...
    bot.send_photo(message.chat.id, "https://interesnyefakty.org/wp-content/uploads/Interesnye-fakty-o-kofe.jpg", caption=facts)
...
def send_coffee_countries(message):
    ...
    bot.send_photo(message.chat.id, "https://coffee.spb.ru/upload/iblock/a7a/a7ad14bdb28b2eeac9b848d8add5231b.jpg", caption=countries)
